...
export default function Home() {
  ...
  {/* Background Overlay Only - No Background Image */}
      ...
      <div className="flex justify-center lg:justify-end">
        <div className="relative">
          <div className="w-full max-w-md lg:max-w-lg">
            <img 
              src="https://www.bhbh.org.uk/wp-content/uploads/2024/09/epc-meaning-image3.webp" 
              alt="EPC Certificate Example" 
              className="w-full h-auto rounded-2xl shadow-2xl transform hover:scale-105 transition-transform duration-300"
            />
          </div>
          {/* Floating Badge */}
          <div className="absolute -top-4 -right-4 bg-yellow-500 text-white px-4 py-2 rounded-full font-bold text-sm shadow-lg">
            A-Rated Example
          </div>
        </div>
      </div>
  ...
  <div className="container mx-auto px-4">
    <div className="max-w-6xl mx-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        {/* Rating Visualization - CORRECTED */}
...
features: ['Manchester Based Service', 'Flexible Scheduling', 'Local Assessors']
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-6xl mx-auto">
            {/* EPC Services */}
            <div className="card-hover bg-gradient-to-br from-green-50 to-white rounded-3xl p-8 shadow-lg border border-green-200 group">
              ...
              <p className="text-gray-600 mb-6 leading-relaxed">
                ...
                Every property transaction requires a valid EPC, and we ensure complete compliance with Manchester regulations.
              </p>
            ...
            {/* Design Consultancy */}
            <div className="card-hover bg-gradient-to-br from-yellow-50 to-white rounded-3xl p-8 shadow-lg border border-yellow-200 group">
              <div className="flex items-center gap-4 mb-6">
              ...
              <Link href="/contact" className="btn-secondary w-full text-center justify-center">
...
<section className="py-20 bg-gradient-to-r from-green-700 via-green-600 to-yellow-500 text-white relative overflow-hidden">
  {/* Background Pattern - Same as Final CTA */}
